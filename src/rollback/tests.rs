...
pub(crate) const BUILDER_FILE_CONTENT: &str = "Hello world";
...
impl TestBuilder {
	pub(crate) fn new() -> Self {
		...
		std::fs::write(&file, BUILDER_FILE_CONTENT).expect("The file exists; qed;");
		Self { file: file }
	}
	...
	pub(crate) fn execute_with_permissionless_temp_dir<F, T, E>(&self, test: F) -> Result<T, E>
	where
		F: FnOnce() -> Result<T, E>,
	{
